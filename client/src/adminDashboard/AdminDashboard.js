...
const AdminDashboard = () => {
  ...
  function addNurse() {
    ...
    function submitForm(formData) {
      ...
      const inputs = document.querySelectorAll(
        "#addNurseForm input, #addNurseForm select"
      );
  ...
  function addVaccine() {
    ...
    vaccineFields.forEach((field) => {
      ...
      input.type =
        field === "Number of Doses Required" || field === "In Stock"
          ? "number"
          : "text";
      input.id = field.toLowerCase().replace(/\s/g, "");
      input.required = true;
  ...
  return (
    <div>
      ...
      <div
        className={`table-container ${showNurseTable ? "visible" : "hidden"}`}
      >
        <h3>
          Nurse Information
      ...
      <div
        className={`table-container ${showVaccineTable ? "visible" : "hidden"}`}
      >
        <h3>
          Vaccine Information
      ...
      <div
        className={`table-container ${showPatientTable ? "visible" : "hidden"}`}
      >
        <h3>
          Patient Information
